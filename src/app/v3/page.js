...
const featuredProducts = [
  {
    title: "Peekaboo Sensory Mat",
    description: "Ultra-soft tummy-time mat with crinkle panels for 0–12 months.",
    price: "LKR 5,200",
    image: "/no-image.jpg",
  },
  {
    title: "Rainbow Stack & Roll",
    description: "Chunky stacking rings that convert into rolling shakers, 6+ months.",
    price: "LKR 4,650",
    image: "/no-image.jpg",
  },
  {
    title: "Cozy Cloud Lovey",
    description: "Weighted cuddle blanket with textured tags for soothing naps.",
    price: "LKR 3,980",
    image: "/no-image.jpg",
  },
  {
    title: "First Puzzles Duo",
    description: "Five two-piece puzzles that build hand-eye coordination, 12+ months.",
    price: "LKR 2,850",
    image: "/no-image.jpg",
  },
  {
    title: "Storytime Sound Cube",
    description: "Press-and-play lullabies with simple volume control for toddlers.",
    price: "LKR 4,450",
    image: "/no-image.jpg",
  },
  {
    title: "Glow Path Tiles",
    description: "Snap-together floor tiles that light up wobbly first steps.",
    price: "LKR 4,890",
    image: "/no-image.jpg",
  },
  {
    title: "Orbit Activity Tray",
    description: "High-chair friendly tray with swap-in sensory bins, 6–18 months.",
    price: "LKR 5,600",
    image: "/no-image.jpg",
  },
  {
    title: "Nebula Bath Set",
    description: "Foam stars and LED bath toys for splash-safe play, 9+ months.",
    price: "LKR 3,450",
    image: "/no-image.jpg",
  },
  {
    title: "Cosmic Craft Bundle",
    description: "Taste-safe finger paints and tactile rollers for tiny creators.",
    price: "LKR 4,990",
    image: "/no-image.jpg",
  },
  {
    title: "Sunrise Story Dice",
    description: "Soft foam dice with picture prompts for early language play.",
    price: "LKR 2,950",
    image: "/no-image.jpg",
  },
];
